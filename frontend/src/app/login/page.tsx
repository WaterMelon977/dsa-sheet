...
export default function LoginPage() {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-zinc-50 dark:bg-black font-sans">
      <div className="w-full max-w-md rounded-2xl bg-white p-8 shadow-xl dark:bg-zinc-900 dark:shadow-none border border-zinc-200 dark:border-zinc-800">
        <div className="flex flex-col items-center gap-6">
          ...
          <div className="flex w-full flex-col gap-3 mt-4">
            <button
              ...
              className="flex h-11 w-full items-center justify-center gap-3 rounded-xl border border-zinc-300 bg-white px-5 text-sm font-medium text-black transition-colors hover:bg-zinc-50 focus:outline-none focus:ring-2 focus:ring-zinc-900 focus:ring-offset-2 dark:border-zinc-700 dark:bg-zinc-800 dark:text-white dark:hover:bg-zinc-700 dark:focus:ring-zinc-100 dark:focus:ring-offset-black"
            >
            ...
            <button
              ...
              className="flex h-11 w-full items-center justify-center gap-3 rounded-xl bg-[#24292e] px-5 text-sm font-medium text-white transition-colors hover:bg-[#1b1f23] focus:outline-none focus:ring-2 focus:ring-zinc-900 focus:ring-offset-2 dark:bg-white dark:text-black dark:hover:bg-zinc-200 dark:focus:ring-white dark:focus:ring-offset-black"
            >
